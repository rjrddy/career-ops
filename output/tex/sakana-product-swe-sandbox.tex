...
\begin{itemize}[leftmargin=1em]
	...
	\item \textbf{Software:} React, Next.js, Node.js, PyTorch, AWS, Docker, PostgreSQL, CI/CD, REST, Linux
\end{itemize}
\hrule
\vspace{\stretch{1}}
...
\begin{itemize}[leftmargin=1em]
	...
	\item
	      ...
	      \begin{itemize*}
	      	\item Built and shipped a full-stack AI telehealth product end-to-end: React/Next.js frontend, Python backend APIs, and PyTorch/Llama-based inference integrated directly into user-facing clinical workflows.
