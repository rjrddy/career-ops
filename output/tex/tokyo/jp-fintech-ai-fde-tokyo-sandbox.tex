...
\begin{itemize}[leftmargin=1em]
	...
	\item
	      ...
	      \begin{itemize*}
	      	\item Built and fine-tuned transformer-based models with PyTorch and Llama for real-time clinical inference, integrating WebRTC video streaming and TypeScript interfaces into the inference loop.
