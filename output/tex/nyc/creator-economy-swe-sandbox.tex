...
\begin{itemize}[leftmargin=1em]
    \parskip=0.1em
	\item \textbf{Languages:} TypeScript, Python, JavaScript, C++, SQL, Java
	\item \textbf{Software:} React, Next.js, Node.js, PostgreSQL, AWS, Docker, CI/CD, REST, Linux
\end{itemize}
\hrule
\vspace{\stretch{1}}
...
\begin{itemize}[leftmargin=1em]
	...
	\item
	      ...
	      \begin{itemize*}
	      	\item Built a greenfield AI telehealth product as one of two engineers, owning the full stack from React/Next.js frontend through Python APIs and PyTorch/Llama inference pipelines deployed on AWS.
	      	\item Iterated directly on physician feedback in a fast-moving small-team environment, shipping improvements across multiple production release cycles with no process overhead.
	      	\item Owned CI/CD and AWS infrastructure end to end, enabling zero-downtime releases across all services.
	      \end{itemize*}
